    ...
    <header class="main-header">
      <div class="container">
       <a href="#" class="top-logo">
         <img src="./../assets/img/nerds-logo.png" height="57" width="139" alt="#">
       </a>
       <nav class="main-nav">
        <ul>
  ...
  <main>
    ...
    <div id="map">
      <div class="container">
        ...
        <a class="feedback" href="#">Напишите нам</a>
      </div>
      <div class="baloon">
      </div>
    </div>
...
.features-column-left b {
  display: block;
  margin-top: 70px;
  line-height: 36px;
  font-size: 36px;
}
.features-column-left h3 {
  display: block;
  margin-top: 46px;
  margin-left: -2px;
  text-transform: uppercase;
...
.features-column-left ul {
  list-style: none;
  padding-left: 36px;
  margin-top: 22px;
}
.features-column-left li {
  margin-bottom: 23px;
  position: relative;
}
.features-column-left li::before {
  content: '';
  position: absolute;
  left: -38px;
  top: 9px;
